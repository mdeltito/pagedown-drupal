...
(function () {
    ...
    Markdown.Editor = function (markdownConverter, id, help) {
        ...
        this.run = function () {
            ...
            uiManager = new UIManager(id, panels, undoManager, previewManager, commandManager, help);
            uiManager.setUndoRedoButtonStates();
    ...
    function PanelCollection(id) {
        this.buttonBar = doc.getElementById(id + '-bar');
        this.preview = doc.getElementById(id + '-preview');
        this.input = doc.getElementById(id);
    };
    ...
    function UIManager(id, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            var xPosition = 0;
            var makeButton = function (button_id, title, XShift, textOp) {
